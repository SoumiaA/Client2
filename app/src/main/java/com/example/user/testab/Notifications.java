...
public class Notifications extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView l = (ListView)v.findViewById(R.id.listviewnotif);
        // list.setVisibility(View.INVISIBLE);
        String[] values = new String[] { "Meftah Lakhder a commente votre publication", "Ada Hanifi a change la photo de profil", "Bourabaa redaa aime votre pub",
              "Flag a actualiser son statut", "Said a commente votre publication ", "Soumia Alem : a commente votre publication",
                "Michel bound a actualiser son statut", "Diego Delaviga a actualiser son statut","Mostfai a actualiser son statut" ,"Obama a actualiser son statut"};
