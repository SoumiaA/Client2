...
public class Amis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View v = inflater.inflate(R.layout.fragment_amis, container, false);
        gridView = (GridView)v.findViewById(R.id.gridView1);
        String[] values = new String[] { "Meftah Lakhder", "Ada Hanifi", "Bourabaa ",
                "Flag ", "Said", "Soumia Alem ",
                "Michel bound ", "Diego Delaviga ","Mostfai " ,"Obama"};

        //Infos User

        //GetUtilisateur user = new GetUtilisateur(infos,getApplicationContext());
        //user.execute();
        gridView.setAdapter(new AmisAdapt(v.getContext(),values));
